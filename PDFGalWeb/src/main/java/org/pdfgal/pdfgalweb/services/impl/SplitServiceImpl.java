...
public class SplitServiceImpl implements SplitService {
	...
	@Override
	public DownloadForm split(final MultipartFile file, final SplitMode splitMode,
			final String pages, final HttpServletResponse response) throws Exception {
		...
		if (!file.isEmpty() && splitMode != null && StringUtils.isNotEmpty(pages)) {
			...
			try {
				...
				final String zipName = this.fileUtils.getFileNameWithoutExtension(originalName)
						+ ".zip";
