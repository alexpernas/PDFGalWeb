...
public class UnProtectServiceImpl implements UnProtectService {
	...
	@Override
	public DownloadForm unProtect(final MultipartFile file,
			final String password, final HttpServletResponse response)
		...
		if (!file.isEmpty() && StringUtils.isNotBlank(password)) {
			...
			try {
				...
				this.pdfGal.unProtect(inputUri, outputUri, password);
					...
					| BadSecurityHandlerException | CryptographyException e) {
